...
class _ExportExcelPageState extends State<ExportExcelPage> {
  ...
  Future<void> exportExcel() async {
    try {
      ...
      // Fetch technician + tool data including e_signature
    ...
    ''');
      ...
      // Add "Signature:" label in the first column
      sheet.appendRow([
